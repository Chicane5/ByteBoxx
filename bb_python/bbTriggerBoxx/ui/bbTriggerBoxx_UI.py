...
#
# Created: Wed Sep 18 23:19:25 2013
...
class Ui_MainWindow_bbTriggerBoxx(object):
    def setupUi(self, MainWindow_bbTriggerBoxx):
        ...
        MainWindow_bbTriggerBoxx.resize(713, 334)
    ...
    def retranslateUi(self, MainWindow_bbTriggerBoxx):
        MainWindow_bbTriggerBoxx.setWindowTitle(_translate("MainWindow_bbTriggerBoxx", "ByteBoxx::TRIGGERBOXX control v1.01", None))
        ...
        self.label.setText(_translate("MainWindow_bbTriggerBoxx", "Subject:", None))
        self.label_3.setText(_translate("MainWindow_bbTriggerBoxx", "Character:", None))
        self.label_4.setText(_translate("MainWindow_bbTriggerBoxx", "Definition:", None))
        self.label_2.setText(_translate("MainWindow_bbTriggerBoxx", "Pose:", None))
        ...
        self.label_6.setText(_translate("MainWindow_bbTriggerBoxx", "Root:", None))
        self.checkBox_mirror.setText(_translate("MainWindow_bbTriggerBoxx", "Mirror Lock?", None))
        self.label_7.setText(_translate("MainWindow_bbTriggerBoxx", "Focus Comp (s):", None))
        self.label_8.setText(_translate("MainWindow_bbTriggerBoxx", "Flash Delay (ms):", None))
        ...
        self.label_9.setText(_translate("MainWindow_bbTriggerBoxx", "Placeholder", None))
        self.tabWidget_master.setTabText(self.tabWidget_master.indexOf(self.tab_post), _translate("MainWindow_bbTriggerBoxx", "Post Process", None))
        self.label_logo.setText(_translate("MainWindow_bbTriggerBoxx", "TextLabel", None))
