...
class Ui_MainWindow_bbTriggerBoxx(object):
    def setupUi(self, MainWindow_bbTriggerBoxx):
        ...
        self.gridLayout_2.addWidget(self.spinBox_cams, 0, 2, 1, 1)
        self.checkBox_jpg = QtGui.QCheckBox(self.groupBox_control)
        self.checkBox_jpg.setChecked(True)
        self.checkBox_jpg.setObjectName(_fromUtf8("checkBox_jpg"))
        self.gridLayout_2.addWidget(self.checkBox_jpg, 0, 3, 1, 1)
        self.checkBox_cr2 = QtGui.QCheckBox(self.groupBox_control)
        self.checkBox_cr2.setChecked(True)
        self.checkBox_cr2.setObjectName(_fromUtf8("checkBox_cr2"))
        self.gridLayout_2.addWidget(self.checkBox_cr2, 0, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_prime, 1, 0, 1, 5)
        ...
        self.gridLayout_2.addWidget(self.pushButton_fire, 2, 0, 1, 5)
        ...
        self.gridLayout_2.addWidget(self.lcdNumber_countdown, 3, 1, 1, 4)
        ...
        self.label.setBuddy(self.spinBox_cams)
    ...
    def retranslateUi(self, MainWindow_bbTriggerBoxx):
        ...
        self.label_3.setText(_translate("MainWindow_bbTriggerBoxx", "Current Batch #:", None))
