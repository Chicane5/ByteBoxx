...
#
# Created: Wed Sep 18 20:13:10 2013
...
class Ui_Dialog_bbTriggerBoxx_config(object):
    def setupUi(self, Dialog_bbTriggerBoxx_config):
        ...
        Dialog_bbTriggerBoxx_config.resize(464, 123)
        ...
        self.checkBox_mirror = QtGui.QCheckBox(Dialog_bbTriggerBoxx_config)
    ...
    def retranslateUi(self, Dialog_bbTriggerBoxx_config):
        Dialog_bbTriggerBoxx_config.setWindowTitle(_translate("Dialog_bbTriggerBoxx_config", "ByteBoxx::TRIGGERBOXX::config v1.01", None))
        self.label.setText(_translate("Dialog_bbTriggerBoxx_config", "Photo Download:", None))
        self.pushButton_browse.setText(_translate("Dialog_bbTriggerBoxx_config", "browse", None))
        self.checkBox_mirror.setText(_translate("Dialog_bbTriggerBoxx_config", "Mirror Lock?", None))
        self.label_7.setText(_translate("Dialog_bbTriggerBoxx_config", "Focus Comp (s):", None))
        self.label_8.setText(_translate("Dialog_bbTriggerBoxx_config", "Flash Delay (ms):", None))
        self.pushButton_save.setText(_translate("Dialog_bbTriggerBoxx_config", "Save to File", None))
        self.pushButton_cancel.setText(_translate("Dialog_bbTriggerBoxx_config", "Cancel", None))
